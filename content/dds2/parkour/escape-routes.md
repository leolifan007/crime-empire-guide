...
| 1 | Person of Interest | Increased patrols in area | 3-5 min inactivity |
...
| Item | Effect | Source |
|------|--------|--------|
| Smoke bombs | Temporary disorient | Craft or purchase |
...
|------|----------------|------------|
| Urban/streets | Roof access via wall-run | Medium |
| Industrial | Container vaults + pipe climbs | Easy |
